...
public class UserStory10 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String destination = "/queries/userStory10.html";
		...
		if(TAC.length()<12){
			...
			try {
				...
				if (!rs.next()){
					...
					out.print("</table>");
					out.print("<br><br><br><a href='/Database/queries/userStory10.html'>Back</a><br>");
					out.print("</body></html>");
				}
			...
			out.print("<br><br><a href='/Database/queries/userStory10.html'>Back   </a><br>");
		}
		out.close();
	}
