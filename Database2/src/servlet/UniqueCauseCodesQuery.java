...
public class UniqueCauseCodesQuery extends HttpServlet {
	...
	public void service(HttpServletRequest req,
		...
		String destination = "/uniqueCauseCodesQuery.html";
		...
		try {
			...
			String user = "root";
			String password = "orangetable893";
			...
			rs = stmt.executeQuery("SELECT distinct imsi, eventCauseID, eventCauseCode,causeCode, causeDescription FROM BaseData b, EventCause e" +
			...
			out.print("</table>");
			out.print("<br><br><br><a href='/Database2/query.html'>Back</a><br>");
			out.print("<a href='/Database2/navigation.html'>   Main</a><br>");
			out.print("</body></html>");
			}
			...
			out.print("<br><br><a href='/Database2/countFailuresQuery.html'>Back   </a><br>");
		}
		out.close();
	}
