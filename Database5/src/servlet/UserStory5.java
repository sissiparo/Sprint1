...
public class UserStory5 extends HttpServlet {
	...
	public void service(HttpServletRequest req,
		...
		String destination = "/queries/userStory5.html";
		...
		if(imsi.length()==15){
			out.print("<br><br>");
			out.print("<a href='/Database/queries/userStory5.html'>Back</a>&nbsp &nbsp");
			if(!(startdate == null)){
			...
			out.print("<br><br><a href='/Database/queries/userStory5.html'>Back</a><br>");
		}
		out.close();
	}
