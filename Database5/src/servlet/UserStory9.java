 ...
 */
//@WebServlet("/Query9")
public class UserStory9 extends HttpServlet {
	...
	public void service(HttpServletRequest req,
		...
		String destination = "/queries/UserStory9.html";
		...
		if(!(startdate == "")){
			...
			out.print("<br><br>&nbsp;&nbsp;<a href='/Database/queries/userStory9.html'>Back</a>"
			...
			out.print("<br><a href='/Database/queries/userStory9.html'>Back</a><br>");
		}
		out.close();
	}
}
